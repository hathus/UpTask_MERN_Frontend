...
const ModalFormTarea = () => {
    ...
    // Definimos los state del formulario de las tareas
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            className='bg-sky-600 hover:bg-sky-700 uppercase w-full p-3 text-white font-bold cursor-pointer transition-colors rounded text-sm'
                                        />
                                    </form>
                                </div>
                            </div>
